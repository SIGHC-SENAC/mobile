      ...
      >
        ...
        <View className="flex-1 bg-[#eef1f6] items-center px-5 pt-7 pb-8">
          ...
          >
            ...
            <Pressable onPress={onForgotPassword} className="items-center mt-3.5">
              <Text className="text-navy font-semibold text-sm">Esqueceu sua senha?</Text>
            </Pressable>

            <Pressable onPress={onFirstAccess} className="items-center mt-3.5">
              <Text className="text-navy font-semibold text-sm">Primeiro acesso? Defina sua senha</Text>
            </Pressable>
          </View>
        </View>
      </ScrollView>
